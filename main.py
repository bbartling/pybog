...
def main():
    ...
    parser.add_argument("-o", "--output", default="analysis.txt", help="Output file for the analysis.")
    parser.add_argument("-d", "--debug", action="store_true", help="Enable debug mode for verbose output.")
    parser.add_argument("-l", "--list-files", action="store_true", help="List all files in the archive and exit.")
