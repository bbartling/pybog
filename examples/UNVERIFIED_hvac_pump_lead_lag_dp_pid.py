...
def build_graph(b: BogFolderBuilder) -> None:
    ...
    b.add_component(
        "kitControl:NumericConst", "DB_Deadband", properties={"value": 2.0}
    )  # °F
    ...
    b.add_numeric_writable(
        "FailConfirm_ms", default_value=5000.0
    )  # confirm not-running
    ...
    b.add_component(
        ...
        "PrevEnable",
        properties={"onDelay": "10", "offDelay": "10"},
    )
    ...
    b.add_component(
        "kitControl:BooleanDelay",
        "P1_FailConfirm",
        properties={"onDelay": "5000", "offDelay": "0"},
    )
    b.add_component(
        "kitControl:BooleanDelay",
        "P2_FailConfirm",
    ...
    b.add_component(
        "kitControl:BooleanDelay",
        "SwapAfterP1Fail",
        properties={"onDelay": "60000", "offDelay": "0"},
    )
    b.add_component(
        "kitControl:BooleanDelay",
        "SwapAfterP2Fail",
    ...
    b.add_component(
        "kitControl:NumericConst", "Reverse", properties={"value": 0.0}
    )  # 0=Reverse, 1=Direct
